...
from backend.io.video_io import get_video_reader, get_video_writer
from backend.io.writers import OutputWriter
...
from shared.io.config_loader import load_and_validate_config
        ...
        try:
            while True:
                ...
                if storage_ratio > 0.9:
                    skip_inference = True
                elif not motion_detector.has_motion(frame_roi):
                    skip_inference = True
                ...
                if video_writer is not None:
                    ...
                    # preserves original camera resolution (e.g. 1920×1080).
