...
def _hash_password(password: str) -> str:
    """Return bcrypt hash of password. Falls back to plaintext if passlib unavailable."""
    try:
...
def _verify_password(password: str, password_hash: str) -> bool:
    """Verify password against bcrypt hash. Falls back to plaintext comparison."""
    try:
        from passlib.hash import bcrypt
...
async def login(req: LoginRequest):
    ...
    try:
        ...
        # Audit log — write directly via repo
