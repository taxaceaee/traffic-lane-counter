...
- **Evidence:** `data/storage` và `data/outputs` writable; Docker API rebuild/start healthy với `STORAGE_ROOT=/app/storage`, `/api/readyz` trả 200 và không còn permission error log.
