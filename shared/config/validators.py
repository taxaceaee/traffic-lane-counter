...
from shared.config.loader import ConfigError, resolve_path
from shared.config.schemas import CameraConfig, LaneConfig, ModelsConfig
...
def _validate_counting_line(lane_id: str, counting_line, width: int, height: int) -> None:
    ...
    if counting_line is None:
        return
    from shared.config.schemas import CountingLineDef
