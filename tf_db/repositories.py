...
from tf_db.models import AuditLog, LaneChangeEvent, TrafficAggregate, User, VehicleCountEvent
...
class SqlAuditRepository:
    ...
    def add_entry(self, entry: dict) -> dict:
        from tf_db.models import AuditLog
        log = AuditLog(**entry)
